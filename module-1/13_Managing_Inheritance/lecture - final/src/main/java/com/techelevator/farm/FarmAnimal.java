...
public abstract class FarmAnimal implements Singable, Sellable {
	...
	/*
	 An abstract method forces a subclass to have that method
	 and provide implementation code for it, unless the subclass
	 itself is abstract.
	 */
	...
	/*
		When a method is marked final it cannot be Overridden in a
		subclass
	 */
