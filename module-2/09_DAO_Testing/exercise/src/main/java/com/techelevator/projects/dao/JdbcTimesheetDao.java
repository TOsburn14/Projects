...
public class JdbcTimesheetDao implements TimesheetDao {
    ...
    public Timesheet createTimesheet(Timesheet newTimesheet) {
        ...
        try {
            newId = jdbcTemplate.queryForObject(sql, Integer.class, newTimesheet.getEmployeeId(), newTimesheet.getProjectId(),
    ...
    public Timesheet updateTimesheet(Timesheet timesheet) {
        ...
        String sql = "UPDATE timesheet " +
                ...
                "WHERE timesheet_id = ?";
        try {
            jdbcTemplate.update(sql, timesheet.getEmployeeId(), timesheet.getProjectId(),
