  ...
  <div id="products">
    ...
    <div class="filter">
      <select v-model="categoryFilter">
        ...
        <option value="Jewerlry">Jewerlry</option>
      </select>
    </div>
      ...
      >
        ...
        <div class="rating">
          <img
            src="../assets/star.png"
            class="ratingStar"
            v-for="n in numberOfStars(product.rating)"
            v-bind:key="n"
          />
          <img
            src="../assets/star_empty.png"
            class="ratingStar"
            v-for="n in numberOfEmptyStars(product.rating)"
            v-bind:key="'empty-' + n"
          />
        </div>
        ...
        <div class="notices">
          ...
          <span v-if="product.quantity === 0" class="limitedstock"
            >Sold Out</span
          >
          <span
